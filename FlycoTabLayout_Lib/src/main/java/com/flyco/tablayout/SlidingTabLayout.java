 ...
 */
public class SlidingTabLayout<T extends CustomTabEntity> extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    private Context mContext;
    private ViewPager mViewPager;
    private ArrayList<T> mTitles;
    ...
    private GradientDrawable mIndicatorDrawable = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, new int[]{0xFFFFB780, 0xFFFF683C});
    ...
    private TextView upText, cuText;
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (mTextsize != mSelectTextsize) {
            mValueAnimator = ValueAnimator.ofFloat(mTextsize, mSelectTextsize);
            ...
            mValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    if (upText != null) {
                        upText.setTextSize(TypedValue.COMPLEX_UNIT_PX, mSelectTextsize - (value - mTextsize));
                    }
                    if (cuText != null) {
                        cuText.setTextSize(TypedValue.COMPLEX_UNIT_PX, value);
                    }
                }
            });
        }
    ...
    public SlidingTabLayout<T> setTitles(ArrayList<T> mTitles) {
     ...
     */
    public void setViewPager(ViewPager vp, ArrayList<T> titles) {
        if (vp == null || vp.getAdapter() == null) {
            throw new IllegalStateException("ViewPager or ViewPager adapter can not be NULL !");
        }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            ...
            CharSequence pageTitle = mTitles == null ? mViewPager.getAdapter().getPageTitle(i) : mTitles.get(i).getTabTitle();
            if (TextUtils.isEmpty(pageTitle)) return;
        ...
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                if (mValueAnimator != null) {
                    textsize = tab_title.getTextSize();
                    if (isSelect && textsize != mSelectTextsize) {
                        cuText = tab_title;
                    } else if (!isSelect && textsize != mTextsize) {
                        upText = tab_title;
                    }
                } else {
