...
public class SegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public void setTabData(ArrayList<CustomTabEntity> titles) {
     ...
     * 关联数据支持同时切换fragments
     */
    public void setTabData(ArrayList<CustomTabEntity> titles, FragmentActivity fa, int containerViewId, ArrayList<Fragment> fragments) {
    ...
    private void addTab(final int position, View tabView) {
        ...
        tv_tab_title.setText(mTitles.get(position).getTabTitle());
